...
if __name__ == "__main__":
    ...
    parser.add_argument("--list", action="store_true", help="List all parsed note titles with indexes")
    ...
    parser.add_argument("--note", type=int, default=0, help="Index of note to preview or upsert (default: 0)")
    ...
    if not (args.list or args.preview or args.upsert or args.search):
        print("ℹ️ No action specified. Use --list, --preview, --upsert, or --search to operate on notes.")